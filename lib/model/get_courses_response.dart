...
class GetCoursesResponse {
  ...
  GetCoursesResponse.fromJson(dynamic json) {
    _status = json['status'];
...
GetCoursesResponse copyWith({  bool? status,
  List<CourseList>? courseList,
}) => GetCoursesResponse(  status: status ?? _status,
...
/// description : "asdf"
/// download_brouchure : "https://developmentalphawizz.com/Nerdmine/public/upload/course_brouchure/dummy.jpg"
...
CourseList copyWith({  String? coursesId,
  ...
  String? get downloadBrouchure => _downloadBrouchure;
