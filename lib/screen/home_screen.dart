...
import 'package:nerdmine/model/update_token_response.dart';
...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  updateToken() async {
    ...
    var formData = FormData.fromMap(body);
     ...
     UpdateTokenResponse response = await apiController.post<UpdateTokenResponse>('https://developmentalphawizz.com/Nerdmine/webService/saveUserToken', body: formData);
