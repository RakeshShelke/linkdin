...
import 'package:nerdmine/model/add_bio_response.dart';
...
class _BioScreenState extends State<BioScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          title: text('Add Bio', textColor: MyColorName.primaryDark, fontFamily: fontMedium, fontSize: 14.sp)),
      body: Padding(
  ...
  callExperienceApi() async {
    ...
    Map<String, dynamic> body = {
      ...
      "bio": expertiseController.text.toString(),
    };

    print(body);
    var formData = FormData.fromMap(body);

    Dialogs.showLoader(context, "Updating bio ...");
