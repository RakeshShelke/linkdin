...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  getData()async{
      Map response = await apiBase.getAPICall(Uri.parse(baseUrl+"registrationFromData"));
      if(response['status']){
          ...
          child: Container(
            ...
            child:   Column(
              ...
              children: [
                ...
                boxHeight(59),
                Container(
                  padding: EdgeInsets.symmetric(horizontal:getWidth(25),vertical: getHeight(6)),
                  decoration: boxDecoration(bgColor: MyColorName.colorBg1,radius: 30,color: Colors.grey.withOpacity(0.3)),
                  child: DropdownButton2(
                      value: userType,
                      isExpanded: true,
                      icon:  Icon(Icons.keyboard_arrow_down_outlined,size: getWidth(60),),
                      onChanged: (value){
                        setState(() {
                          userType =value.toString();
                        });
                      },
                      dropdownWidth: getWidth(625),
                      underline: SizedBox(),
                      hint: text(
                          "Select profession",
               ...
               /* TextField(
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: Container(
                      padding: EdgeInsets.all(getWidth(20)),
                      child: Image.asset(Assets.imagesName,
                        height: getWidth(29),
                        width: getWidth(29), fit: BoxFit.fill,
                      ),
                    ),
...
controller: emailCon,
                  decoration: InputDecoration(
                    ...
                    suffixIcon: Container(
                      padding: EdgeInsets.all(getWidth(20)),
                      child: Image.asset(Assets.imagesMail,
                        height: getWidth(29),
                        width: getWidth(29), fit: BoxFit.fill,
                      ),
                    ),
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: Container(
                      padding: EdgeInsets.all(getWidth(20)),
                      child: Image.asset(Assets.imagesRefer,
                        height: getWidth(29),
                        width: getWidth(40), fit: BoxFit.fill,
                      ),
                    ),
  ...
  loginUser() async {
    ...
    if (isNetwork) {
      try {
        ...
        Map response = await apiBase.postAPICall(Uri.parse(baseUrl + "userRegistration"), data);
        print(response);
        bool status = true;
        setState(() {
          loading = false;
