                ...
                children: [
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ClipRRect(borderRadius: BorderRadius.circular(100), child: commonImage("${pageModel?.info?.profileLogo}", 110.0, 110.0, "", context, "")),
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        if ((pageModel?.info?.phoneNo?.isNotEmpty ?? false) ||
                            (pageModel?.info?.email?.isNotEmpty ?? false) ||
                            (pageModel?.info?.website?.isNotEmpty ?? false) ||
                            (pageModel?.info?.address?.isNotEmpty ?? false) ||
                            (pageModel?.info?.city?.isNotEmpty ?? false) ||
                            (pageModel?.info?.zipCode?.isNotEmpty ?? false))
                          text("Contact Information".toString(), textColor: MyColorName.primaryDark, fontFamily: fontMedium, fontSize: 12.sp),
                        boxHeight(10),
                        if (pageModel?.info?.phoneNo?.isNotEmpty ?? false)
                          Row(
                            children: [
                              text("Phone No: ".toString(), textColor: MyColorName.appbarBg, fontFamily: fontMedium, fontSize: 12.sp),
                              text(" ${pageModel?.info?.phoneNo}".toString(), textColor: MyColorName.appbarBg, fontFamily: fontMedium, fontSize: 10.sp),
                            ],
                          ),
                        if (pageModel?.info?.email?.isNotEmpty ?? false)
                          Row(
                            children: [
                              text("Email: ".toString(), textColor: MyColorName.appbarBg, fontFamily: fontMedium, fontSize: 12.sp),
                              text(" ${pageModel?.info?.email}".toString(), textColor: MyColorName.appbarBg, fontFamily: fontMedium, fontSize: 10.sp),
                            ],
                          ),
                        if (pageModel?.info?.website?.isNotEmpty ?? false)
                          Row(
                            children: [
                              text("Website: ".toString(), textColor: MyColorName.appbarBg, fontFamily: fontMedium, fontSize: 12.sp),
                              Expanded(
                                  child: Text("${pageModel?.info?.website}".toString(), style: textStyle14px500w).onClick(() {
                                launch("${pageModel?.info?.website}".toString());
                              })),
                            ],
                          ),
                        if (pageModel?.info?.address?.isNotEmpty ?? false)
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            mainAxisAlignment: MainAxisAlignment.start,
                            children: [
                              text("Address: ".toString(), textColor: MyColorName.appbarBg, fontFamily: fontMedium, fontSize: 12.sp),
                              Expanded(child: Text("${pageModel?.info?.address}".toString(), style: textStyle14px500w)),
                            ],
                          ),
                        if (pageModel?.info?.city?.isNotEmpty ?? false)
                          Row(
                            children: [
                              text("City: ".toString(), textColor: MyColorName.appbarBg, fontFamily: fontMedium, fontSize: 12.sp),
                              text("${pageModel?.info?.city}".toString(), textColor: MyColorName.appbarBg, fontFamily: fontMedium, fontSize: 10.sp),
                            ],
                          ),
                        if (pageModel?.info?.zipCode?.isNotEmpty ?? false)
                          Row(
                            children: [
                              text("Zip Code: ".toString(), textColor: MyColorName.appbarBg, fontFamily: fontMedium, fontSize: 12.sp),
                              text("${pageModel?.info?.zipCode}".toString(), textColor: MyColorName.appbarBg, fontFamily: fontMedium, fontSize: 10.sp),
                            ],
                          )
                      ],
                    ),
