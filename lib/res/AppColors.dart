...
/// Created by Pratik Kataria on 07-08-2022.

abstract class AppColors {
  //Basic colors
  static const colorPrimary = Color(0xFF02778B);
  ...
  static const textColorGreen = Color(0xFF128398);
  ...
  //Shimmer color
  static const baseLightColor = Color(0xFFF6F6F6);
  static const highLightColor = Color(0xFFE6E6E6);
  static const shimmerBackgroundColor = Color(0xFFEAEAEA);

  //App Specific color
  static const lineColor = Color(0xFFEBEBEB);
  static const buttonStartGradient = Color(0xFF1C5BDF);
  static const buttonEndGradient = Color(0xFF5C91FF);
  static const boxShadow = Color(0xFFEAEAEA);
  static const backgroundColor = Color(0xFFF8F8F8);
  static const backgroundScreenColor = Color(0xFFFFFEFA);
  static const alert = Color(0xFFFAA85B);
  static const homeCard = Color(0xFFF4F5F7);
